...
cd (uigetdir)
    ...
    assignin("base","zscore_minus",zscore_minus);
    assignin("base","zscore_plus",zscore_plus);
    assignin("base","df_csminus",df_csminus);
    assignin("base","df_csplus",df_csplus);

    zscore_all = horzcat(mean(zscore_plus)',mean(zscore_minus)');
    assignin("base",'zscore_all',zscore_all);
    save('zscore.mat');
